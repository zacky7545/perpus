    ...
    <form action="edit.php" method="post" enctype="multipart/form-data" id="form1">
        <table cellpadding="10" cellspacing="0">
            <tr>
                ...
                <td width="2%">:</td>
                <td width="82%"><input name="id_buku" type="text" size="20" maxlength="20" value="<?php echo $data['id_buku']; ?>" required></td>
            </tr>
            <tr>
                <td>NAMA_BUKU</td>
                <td>:</td>
                <td><input name="nama_buku" type="text" size="40" maxlength="50" value="<?php echo $data['nama_buku']; ?>" required></td>
<!-- Cara Menampilkan data yang telah diekstraksi menggukana kode php seperti didalam value -->
            </tr>
            <tr>
                <td>PENERBIT</td>
                <td>:</td>
                <td><input name="penerbit" type="text" size="40" maxlength="50" value="<?php echo $data['penerbit']; ?>" required></td>
            </tr>
            <tr>
                <td>TAHUN_TERBIT</td>
                <td>:</td>
                <td><input name="tahun_terbit" type="text" size="40" maxlength="50" value="<?php echo $data['tahun_terbit']; ?>" required></td>
            </tr>
            <tr>
                <td>JUMLAH</td>
                <td>:</td>
                <td><input name="jumlah" type="text" size="40" maxlength="50" value="<?php echo $data['jumlah']; ?>" required></td>
            </tr>
            <tr>
                <td>ISBN</td>
                <td>:</td>
                <td><input name="isbn" type="text" size="40" maxlength="50" value="<?php echo $data['isbn']; ?>" required></td>
            </tr>
            <tr>
                <td></td>
                <td></td>
